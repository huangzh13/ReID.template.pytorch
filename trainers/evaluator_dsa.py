...
class EvaluatorDSA:
    ...
    def evaluate(self, query_loader, gallery_loader, ranks=None, save_fig=False):
        ...
        for inputs in query_loader:
            inputs, pids, cids = self._parse_data(inputs)
    ...
    def _parse_data(self, inputs):
        ...
        return (imgs.cuda(), imgs_dsap.cuda()), pids, camids
